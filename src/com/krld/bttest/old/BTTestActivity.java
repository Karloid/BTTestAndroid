...
public class BTTestActivity extends Activity {
    ...
    private static String MacAddress = "36:9D:48:93:76:A5"; // MAC-адрес БТ модуля
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toServer.setOnClickListener(new OnClickListener(){

            @Override
            public void onClick(View p1)
            {
                try {
                    Intent intent = new Intent(p1.getContext(), ServerActivity.class);
                    startActivityForResult(intent,0);
                } catch (Exception e){
                    Log.d(LOG_TAG, "error intent to old_server button");
                }}
        });
    ...
    public void onResume() {
        ...
        try {
            ...
            Log.d(LOG_TAG, "***Соединение не получилось установить*** " + e.getMessage());
            try {
                btSocket.close();
        ...
        MyThred = new ConnectedThread(btSocket);
        MyThred.start();
    }
